        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join our next cohort and start your transformation journey with fellow athletes
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-gray-200 max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">🤝 Evolve Squad™</h3>
                  <p className="text-lg text-gray-600">5-Week Small Group Program</p>
                </div>
              </div>
              <div className="text-right">
                <div className="bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-semibold mb-2">
                  Starting Soon
                </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-700">
                  ...
                  <li className="flex items-center">
                    ...
                    <span><strong>Duration:</strong> 5 weeks (1 hour per week)</span>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-primary-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z" />
                    </svg>
                    <span><strong>Group Size:</strong> 6-8 athletes (ages 14-18)</span>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-primary-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
                    </svg>
                    <span><strong>Focus:</strong> Psycho-emotional development</span>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-primary-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z" clipRule="evenodd" />
                    </svg>
                    <span><strong>Spots Available:</strong> 4 remaining</span>
                  </li>
                </ul>
              </div>

              <div>
                <h4 className="text-lg font-semibold text-gray-900 mb-4">Your Mentor</h4>
                <div className="flex items-center mb-4">
                  <img src="/alan-nixon.jpg" alt="Alan Nixon" className="w-20 h-20 rounded-full object-cover mr-4" />
                  <div>
                    <p className="font-bold text-gray-900 text-lg">Alan Nixon</p>
                    <p className="text-sm text-primary-600 font-medium">UEFA Pro License & Global Coach Educator</p>
                    <p className="text-sm text-gray-600 mt-1">25+ years • 47 countries</p>
                  </div>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  <p className="text-gray-700 text-sm leading-relaxed">
                    "This program focuses on the mental and emotional aspects that separate good athletes from great ones. We'll work together as a squad to build resilience, confidence, and the mindset needed for peak performance."
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-center">
                    ...
                    5 weekly group sessions (1 hour each)
                  </li>
                  <li className="flex items-center">
                    <svg className="w-4 h-4 text-primary-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    Weekly challenge-oriented tasks
                  </li>
                  <li className="flex items-center">
                    <svg className="w-4 h-4 text-primary-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="text-center">
              <div className="mb-4">
                <p className="text-sm text-gray-600 mb-2">Limited spots available • Registration closes Friday</p>
                <p className="text-lg font-semibold text-gray-900">"Stronger together. Growing as one."</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
