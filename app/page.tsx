...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="upcoming-classes" className="py-24 bg-primary-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose your program and start your transformation journey with fellow athletes
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {/* Alan Nixon - Monday */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">🤝 Evolve Squad™</h3>
                <p className="text-gray-600 mb-4">5-Week Program</p>
              </div>

              <div className="flex items-center mb-4">
                <img src="/alan-nixon.jpg" alt="Alan Nixon" className="w-12 h-12 rounded-full object-cover mr-3" />
                <div>
                  <p className="font-semibold text-gray-900">Alan Nixon</p>
                  <p className="text-sm text-primary-600">UEFA Pro License</p>
                </div>
              </div>
              ...
              <div className="text-center">
                <p className="text-2xl font-bold text-primary-600 mb-4">$350</p>
                <a href="#register-interest" className="w-full bg-primary-600 text-white py-3 rounded-lg font-semibold hover:bg-primary-700 transition-colors block">
                  Reserve Spot
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105">
              ...
              <div className="flex items-center mb-4">
                <img src="/piotr-paprocki.jpg" alt="Piotr 'Papi' Paprocki" className="w-12 h-12 rounded-full object-cover mr-3" />
                <div>
                  <p className="font-semibold text-gray-900">Piotr "Papi" Paprocki</p>
                  <p className="text-sm text-primary-600">Leadership Coach</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105">
              ...
              <div className="flex items-center mb-4">
                <img src="/kurtis-milan.jpg.png" alt="Kurtis Millan" className="w-12 h-12 rounded-full object-cover mr-3" />
                <div>
                  <p className="font-semibold text-gray-900">Kurtis Millan</p>
                  <p className="text-sm text-primary-600">UEFA A License Coach</p>
                </div>
              </div>
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-4">Limited spots available • Registration closes Friday</p>
            <p className="text-lg font-semibold text-gray-900 mb-6">"Stronger together. Growing as one."</p>
            <a href="#evolve-squad-details" className="inline-block border-2 border-primary-600 text-primary-600 px-8 py-4 rounded-lg font-semibold hover:bg-primary-50 transition-colors">
