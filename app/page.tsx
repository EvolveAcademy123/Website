...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="group-classes" className="py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join our weekly group sessions designed to build motivation, confidence, and mental resilience alongside fellow athletes.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-gray-200 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Motivation & Mindset Sessions</h3>
              <p className="text-lg text-gray-600 mb-6">
                Weekly group sessions focused on building mental strength, motivation, and resilience
              </p>
            </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-center">
                    ...
                    <span><strong>When:</strong> Every Monday, 5:00 PM - 6:00 PM</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-primary-600 rounded-full mr-3"></div>
                    <span><strong>Focus:</strong> Motivation & Mental Performance</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-primary-600 rounded-full mr-3"></div>
                    <span><strong>Format:</strong> Interactive Group Sessions</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-primary-600 rounded-full mr-3"></div>
                    <span><strong>Group Size:</strong> Small Groups (8-12 Athletes)</span>
                  </li>
                </ul>
              </div>

              <div>
                <h4 className="text-lg font-semibold text-gray-900 mb-4">Led by Christopher Ricardi</h4>
                <div className="flex items-center mb-4">
                  <img src="/christopher-ricardi.jpg.png" alt="Christopher Ricardi" className="w-16 h-16 rounded-full object-cover mr-4" />
                  <div>
                    <p className="font-medium text-gray-900">Christopher Ricardi</p>
                    <p className="text-sm text-primary-600">Sport Mental Performance Consultant</p>
                  </div>
                </div>
                <p className="text-gray-700 text-sm leading-relaxed">
                  Chris brings extensive experience in sport psychology and mental performance training to help athletes develop the mindset and motivation needed for peak performance.
                </p>
              </div>
            </div>
